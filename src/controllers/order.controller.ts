...
import { createSignature, gamelovHeaderDate, getPrimitiveValues, getQueries, sortAndConcatenate, tokenExists } from "../helpers/helper";
...
export const placeOrder = async (req: Request, res: Response) => {
  ...
  const signature = createSignature(path, method, sortedAndConcatenated, token as string, xGiftlovDate)
